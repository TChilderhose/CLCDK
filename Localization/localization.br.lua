if (select(2, UnitClass("player")) == "DEATHKNIGHT" and GetLocale() == "ptBR" ) then
	...
	CLCDK_OPTIONS_CDR_POOLINTERRUPT = "Conjunto PR de Interrupcao" 
	...
	CLCDK_OPTIONS_CDR_ALT_ROT_UNHOLY = "None"
	...
	CLCDK_ABOUT = "Sobre"
	CLCDK_ABOUT_BODY = "Possue Perguntas? Sugestoes? ou deseja mais informacoes?<br/>Deixe um comentario em Curse.com ou Wowinterface.com"
	...
	CLCDK_ABOUT_AUTHOR = "Autor: Threk - Illidan US"
	CLCDK_ABOUT_VERSION = "Versao: ".. GetAddOnMetadata("CLCDK", "Version")
end