...
function CLCDK.CreateUI()
	...
	CLCDK.RuneBar.Text:SetPoint("TOP", CLCDK.RuneBar, "TOP", 0, -6)
	CLCDK.RuneBar.Text:SetJustifyH("CENTER")
	CLCDK.RuneBar.Text:SetFont(CLCDK.FONT_MONO, CLCDK.FONT_SIZE_L, "THICKOUTLINE")
	...
	CLCDK.RunicPower.Text:SetPoint("TOP", CLCDK.RunicPower, "TOP", 0, -6)
	CLCDK.RunicPower.Text:SetJustifyH("CENTER")
	CLCDK.RunicPower.Text:SetFont(CLCDK.FONT_MONO, CLCDK.FONT_SIZE_L, "THICKOUTLINE")
	...
	CLCDK.Disease.Text:SetPoint("TOP", CLCDK.Disease, "TOP", 0, -6)
	CLCDK.Disease.Text:SetJustifyH("CENTER")
	CLCDK.Disease.Text:SetFont(CLCDK.FONT_MONO, CLCDK.FONT_SIZE_L, "THICKOUTLINE")
